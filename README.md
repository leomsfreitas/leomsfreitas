...
To stack the images vertically, wrap them in a `<div>` with `display: flex` and `flex-direction: column`:
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
    ...
    <img width="50%" src="perfil_blob_v2.png"/>
</div>
```

Or use a simpler approach with `<br>` tags:
